    ...
    return (
        <div className="Creation-container">
            <form onSubmit={handleSubmit}>
                ...
                <h5><input className='checker' type="checkbox" checked={isChecked} onChange={handleTermsChange}/>I Have Read the<a className="Forgot-Password" href=""> Terms & Conditions</a></h5>
