      ...
      <div className="main-container">
        ...
        <div className="stylee">
                ...
                <ul>
                  <ul>
                    <li className="small-text">
                      <img src={iconImage} alt="New Icon" /> 62% New
                    </li>
                    <li className="small-text">
                      <img src={iconImage1} alt="Returning Icon" /> 13%
                      Returning
                    </li>
                    <li className="small-text">
                      <img src={iconImage2} alt="Inactive Icon" /> 23% Inactive
                    </li>
                  </ul>
                </ul>
              </div>
          ...
          <div className="compo6">
            ...
            <h5>
              {" "}
              User Management<span>139</span>
            </h5>
            <h5>
              {" "}
              Content Management <span>283</span>
            </h5>
            <h5>
              {" "}
              Data Management <span>782</span>
            </h5>
            <h5>
              {" "}
              Document Managemens <span>1,923</span>
            </h5>
            <h5>
              {" "}
              Reporting and Analytics <span>103</span>
            </h5>
            <h5>
              {" "}
              Integration and APIs<span>477</span>
            </h5>
            <h5>
              {" "}
              Training and Support <span>280</span>
            </h5>
          </div>
          ...
          <div className="compo7">
            ...
            <ul>
              <h4>
                <li className="small-text">
                  {/* <img src={iconImage3} alt="New Icon" /> */}
                </li>
              </h4>
              <h4>
                <li className="small-text">
                  {/* <img src={iconImage4} alt="New Icon" /> */}
                  Abdelrahman Mohamed
                </li>
              </h4>
              ...
              <h4>
                <li className="small-text">
                  {/* <img src={iconImage5} alt="New Icon" /> */}
                  Mahmoud El-Maghraby
                </li>
              </h4>
              ...
              <h4>
                <li className="small-text">
                  {/* <img src={iconImage6} alt="New Icon" /> */}
                  Mohamed Badran
                </li>
              </h4>
              ...
              <h4>
                <li className="small-text">
                  {/* <img src={iconImage7} alt="New Icon" /> */}
                  Wael Badran
                </li>
              </h4>
              ...
              <h4>
                <li className="small-text">
                  {/* <img src={iconImage8} alt="New Icon" /> */}
                  Ahmed El-Ghazoly
                </li>
              </h4>
        ...
        <div className="stylee">
            ...
            <div className="info">
              <div className="percentages">
                <ul>
                  <ul>
                    <li className="small-text">
                      <img src={iconImage} alt="New Icon" /> 40% Prepaid
                    </li>
                    <li className="small-text">
                      <img src={iconImage1} alt="Returning Icon" /> 60% Postpaid
                    </li>
                  </ul>
                </ul>
              </div>
          ...
          <div className="compo6">
            ...
            <h5>
              {" "}
              Nozhat to MIU (UNI)<span>1,500</span>
            </h5>
            <h5>
              {" "}
              Rehab to GUC (UNI)<span>1,080</span>
            </h5>
            <h5>
              {" "}
              Mohandiseen to AUC (UNI)<span>383</span>
            </h5>
            <h5>
              {" "}
              Mokkataam to MTI (UNI)<span>582</span>
            </h5>
            <h5>
              {" "}
              6th October to MSA (UNI)<span>1000</span>
            </h5>
            <h5>
              {" "}
              New Cairo to FUE (UNI)<span>680</span>
            </h5>
            <h5>
              {" "}
              Abbassiya to Cairo (UNI)<span>350 </span>
            </h5>
          </div>
